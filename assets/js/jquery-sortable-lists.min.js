...
(function(d) {
    d.fn.sortableLists = function(e) {
        ...
        function n(a) {
            ...
            offset = h.offset();
            r.el.animate({
                    //left: offset.left - b.cEl.mL,
                    top: offset.top - b.cEl.mT
                },
                250,
                function() {
                    D(r);
                    ...
                    g ? b.placeholderNode.slideUp(150,
                        function() {
        ...
        function C(a, b) {
            var c = b.cEl;
            c.el.css({
                top: a.pageY - c.xyOffsetDiff.Y - c.mT,
                //left: a.pageX - c.xyOffsetDiff.X - c.mL
            })
        }
        ...
        function A(a, f) {
            ...
            if (b.rootEl.el.find(c).length) {
                ...
                if (!c.is("li")) return c = c.closest("li"),
                    c[0] ? c: null;
                if (c.is("li")) return c
            } else return null
        }
        ...
        var u = d("body").css("position", "relative"),
            ...
            F = d("<" + f.listSelector + " />").prependTo(u).attr("id", "sortableListsBase").css(f.baseCss).addClass(f.baseClass),
            ...
            w = d("<span />").addClass("sortableListsOpener " + f.opener.openerClass).css("background-image", "url(" + f.opener.close + ")").css(f.opener.openerCss).on("mousedown",
                function(a) {
                    a = d(this).closest("li");
        ...
        return this.on("mousedown",
            function(a) {
                ...
                if (e[0]) {
                    ...
                    b.cEl.xyOffsetDiff = {
                        X: a.pageX - b.cEl.offset.left,
                        Y: a.pageY - b.cEl.offset.top
                    };
    ...
    d.fn.sortableListsToArray = function(e, m, n) {
        ...
        this.children("li").each(function() {
            var k = d(this),
                p = {},
                q;
            if (! (q = k.attr("id"))) throw console.log(k),
                "Previous item in console.log has no id. It is necessary to create the array.";
            p.id = q;
            p.parentId = m;
            p.value = k.attr("value");
            p.branchOrder = g;
            e.push(p);
            n++;
    ...
    d.fn.sortableListsToHierarchy = function() {
        ...
        d(this).children("li").each(function() {
            var n, g = {},
                k = d(this);
            if (! (n = k.attr("id"))) throw console.log(k),
                "Previous item in console.log has no id. It is necessary to create the array.";
            g.id = n;
            g.parentId = m;
            g.value = k.attr("value");
            g.order = m;
    ...
    d.fn.sortableListsToString = function(e, m) {
        ...
        d(this).children("li").each(function() {
            var n, g = d(this);
            if (! (n = g.attr("id"))) throw console.log(g),
                "Previous item in console.log has no id. It is necessary to create the array.";
            e.push(n + "=" + m);
